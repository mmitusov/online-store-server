...
class UserController {
    ...
    async check(req, res, next) {        
        ...
        //Ведь если юзер не заходил на наш сайт дольше чем 24 часа (это условие указывали выше) - токен будет просрочен и мы попросим езера вновь залогиниться (Token is not found. You're not athorized)
