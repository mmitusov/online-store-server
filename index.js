...
const app = express();
//Регестрируем установленные модули при помощи midleware, чтобы эти модули работали в рамках нашего приложения. Експеремент: Перестановка местами наших midleware не повлияла на работу сервера. По видимому очередность их вызова не важна? 
app.use(cors());
